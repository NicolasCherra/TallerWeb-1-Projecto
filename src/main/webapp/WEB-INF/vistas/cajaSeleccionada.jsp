			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form:form method="POST" action="hacerRegalo"
						modelAttribute="RegaloForm" class="form-inline">
					...
					<form:form method="POST" action="hacerRegalo"
						...
						<div class="w-100">
							...
							<div class="form-group w-100">
								...
								placeholder="Mensaje (Opcional ()rwrwrwre" class="mensaje form-control w-100"
								id="mensaje" 
						...
						<div class="d-flex justify-content-center w-100">
							...
							<form:button type="submit"
								class="btn btn-primary text-uppercase js-scroll-trigger p-2 pl-5 pr-5 font-weight-bold">Enviar</form:button>
						</div>
					</form:form>
				</div>
